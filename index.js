...
*/
console.log('task 1b', createMenuItem)
...
*/
reviews.push({name: "Jay", rating: 2, feedback:"ehh"})
console.log(reviews)
...
function getLastReview(objects) {
  ...
  return objects[objects.length-1].name + " gave the restaurant a " + objects[objects.length-1].rating + " star review, and their feedback was: " + objects[objects.length-1].feedback
} 
